...
public class change_pwd_other extends Activity {
    //local declarations
    private static final String TAG = change_pwd_other.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_pwd_other);
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(change_pwd_other.this, otherUserPage.class));
        finish();
