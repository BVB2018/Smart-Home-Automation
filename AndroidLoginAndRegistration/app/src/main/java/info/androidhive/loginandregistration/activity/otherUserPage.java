...
public class otherUserPage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActivities.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(otherUserPage.this, otherUserActivity.class);
        ...
        btnChPd.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(otherUserPage.this, change_pwd_other.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(otherUserPage.this, LoginActivity.class));
        finish();
