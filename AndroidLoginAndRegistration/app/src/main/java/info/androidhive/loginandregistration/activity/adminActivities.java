...
public class adminActivities extends Activity {
//local declarations
    private static final String TAG = adminActivities.class.getSimpleName();
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(adminActivities.this, adminPage.class));
        finish();
